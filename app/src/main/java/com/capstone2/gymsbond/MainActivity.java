...
import com.capstone2.gymsbond.interaction_chat.messages.LatestMessageActivity;
...
//        MainActivity mainActivity = null;
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        }else  if(itemId == R.id.nav_privacy)
        {
            ...
            Intent intent = new Intent(this, LatestMessageActivity.class);
            startActivity(intent);

        } else if (itemId == R.id.nav_nearby) {
            Intent intent = new Intent(this, NearbyChatActivity.class);
            startActivity(intent);
        }
